        ...
        <div class="flex min-h-screen" x-data="{ sidebarOpen: true, companyDropdown: false, profileDropdown: false, langDropdown: false }">
            ...
            <aside class="sidebar fixed inset-y-0 left-0 z-30 flex flex-col bg-slate-900 text-slate-300 shadow-xl"
                ...
                <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
                    ...
                    <!-- Draft Faktur -->
                    <a href="{{ route('taxes.draft_faktur.index') }}" class="sidebar-link flex items-center px-3 py-2.5 rounded-lg text-sm {{ request()->routeIs('taxes.draft_faktur.*') ? 'active text-white font-medium' : 'hover:bg-slate-800 hover:text-white' }}">
                        <div class="w-8 h-8 rounded-lg bg-slate-800/50 flex items-center justify-center mr-3 border border-slate-700/50 sidebar-icon">
